...
export const UserLibraryServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getUsersByUseridItemsLatest: async (userId: string, limit?: number, parentId?: string, fields?: string, includeItemTypes?: string, isFolder?: boolean, isPlayed?: boolean, groupItems?: boolean, enableImages?: boolean, imageTypeLimit?: number, enableImageTypes?: string, enableUserData?: boolean, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'userId' is not null or undefined
            if (userId === null || userId === undefined) {
...
export const UserLibraryServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getUsersByUseridItemsLatest(userId: string, limit?: number, parentId?: string, fields?: string, includeItemTypes?: string, isFolder?: boolean, isPlayed?: boolean, groupItems?: boolean, enableImages?: boolean, imageTypeLimit?: number, enableImageTypes?: string, enableUserData?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<BaseItemDto>>> {
            const localVarAxiosArgs = await UserLibraryServiceApiAxiosParamCreator(configuration).getUsersByUseridItemsLatest(userId, limit, parentId, fields, includeItemTypes, isFolder, isPlayed, groupItems, enableImages, imageTypeLimit, enableImageTypes, enableUserData, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const UserLibraryServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getUsersByUseridItemsLatest(userId: string, limit?: number, parentId?: string, fields?: string, includeItemTypes?: string, isFolder?: boolean, isPlayed?: boolean, groupItems?: boolean, enableImages?: boolean, imageTypeLimit?: number, enableImageTypes?: string, enableUserData?: boolean, options?: any): AxiosPromise<Array<BaseItemDto>> {
            return UserLibraryServiceApiFp(configuration).getUsersByUseridItemsLatest(userId, limit, parentId, fields, includeItemTypes, isFolder, isPlayed, groupItems, enableImages, imageTypeLimit, enableImageTypes, enableUserData, options).then((request) => request(axios, basePath));
        },
        /**
         * Requires authentication as user
         * @summary Gets the root folder from a user's library
...
export class UserLibraryServiceApi extends BaseAPI {
     ...
     * @memberof UserLibraryServiceApi
     */
    public getUsersByUseridItemsLatest(userId: string, limit?: number, parentId?: string, fields?: string, includeItemTypes?: string, isFolder?: boolean, isPlayed?: boolean, groupItems?: boolean, enableImages?: boolean, imageTypeLimit?: number, enableImageTypes?: string, enableUserData?: boolean, options?: any) {
        return UserLibraryServiceApiFp(this.configuration).getUsersByUseridItemsLatest(userId, limit, parentId, fields, includeItemTypes, isFolder, isPlayed, groupItems, enableImages, imageTypeLimit, enableImageTypes, enableUserData, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requires authentication as user
     * @summary Gets the root folder from a user's library
