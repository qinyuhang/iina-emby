 ...
 * @export
 */
export const VideoHlsServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @throws {RequiredError}
         */
        getVideosByIdLiveM3u8: async (id: string, container: string, deviceProfileId?: string, deviceId?: string, audioCodec?: string, enableAutoStreamCopy?: boolean, audioSampleRate?: number, audioBitRate?: number, audioChannels?: number, maxAudioChannels?: number, _static?: boolean, profile?: string, level?: string, framerate?: number, maxFramerate?: number, copyTimestamps?: boolean, startTimeTicks?: number, width?: number, height?: number, maxWidth?: number, maxHeight?: number, videoBitRate?: number, subtitleStreamIndex?: number, subtitleMethod?: string, maxRefFrames?: number, maxVideoBitDepth?: number, videoCodec?: string, audioStreamIndex?: number, videoStreamIndex?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling getVideosByIdLiveM3u8.');
            }
            // verify required parameter 'container' is not null or undefined
            if (container === null || container === undefined) {
                throw new RequiredError('container','Required parameter container was null or undefined when calling getVideosByIdLiveM3u8.');
            }
            const localVarPath = `/Videos/{Id}/live.m3u8`
                .replace(`{${"Id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
...
export const VideoHlsServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getVideosByIdLiveM3u8(id: string, container: string, deviceProfileId?: string, deviceId?: string, audioCodec?: string, enableAutoStreamCopy?: boolean, audioSampleRate?: number, audioBitRate?: number, audioChannels?: number, maxAudioChannels?: number, _static?: boolean, profile?: string, level?: string, framerate?: number, maxFramerate?: number, copyTimestamps?: boolean, startTimeTicks?: number, width?: number, height?: number, maxWidth?: number, maxHeight?: number, videoBitRate?: number, subtitleStreamIndex?: number, subtitleMethod?: string, maxRefFrames?: number, maxVideoBitDepth?: number, videoCodec?: string, audioStreamIndex?: number, videoStreamIndex?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await VideoHlsServiceApiAxiosParamCreator(configuration).getVideosByIdLiveM3u8(id, container, deviceProfileId, deviceId, audioCodec, enableAutoStreamCopy, audioSampleRate, audioBitRate, audioChannels, maxAudioChannels, _static, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, maxWidth, maxHeight, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, videoCodec, audioStreamIndex, videoStreamIndex, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
 ...
 * @export
 */
export const VideoHlsServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * No authentication required
         * @param {string} playlistId 
         ...
         * @throws {RequiredError}
         */
        getVideosByIdLiveM3u8(id: string, container: string, deviceProfileId?: string, deviceId?: string, audioCodec?: string, enableAutoStreamCopy?: boolean, audioSampleRate?: number, audioBitRate?: number, audioChannels?: number, maxAudioChannels?: number, _static?: boolean, profile?: string, level?: string, framerate?: number, maxFramerate?: number, copyTimestamps?: boolean, startTimeTicks?: number, width?: number, height?: number, maxWidth?: number, maxHeight?: number, videoBitRate?: number, subtitleStreamIndex?: number, subtitleMethod?: string, maxRefFrames?: number, maxVideoBitDepth?: number, videoCodec?: string, audioStreamIndex?: number, videoStreamIndex?: number, options?: any): AxiosPromise<void> {
...
export class VideoHlsServiceApi extends BaseAPI {
    ...
    public getVideosByIdHlsByPlaylistidBySegmentidBySegmentcontainer(playlistId: string, segmentId: string, segmentContainer: string, id: string, container: string, deviceProfileId?: string, deviceId?: string, audioCodec?: string, enableAutoStreamCopy?: boolean, audioSampleRate?: number, audioBitRate?: number, audioChannels?: number, maxAudioChannels?: number, _static?: boolean, profile?: string, level?: string, framerate?: number, maxFramerate?: number, copyTimestamps?: boolean, startTimeTicks?: number, width?: number, height?: number, maxWidth?: number, maxHeight?: number, videoBitRate?: number, subtitleStreamIndex?: number, subtitleMethod?: string, maxRefFrames?: number, maxVideoBitDepth?: number, videoCodec?: string, audioStreamIndex?: number, videoStreamIndex?: number, options?: any) {
        return VideoHlsServiceApiFp(this.configuration).getVideosByIdHlsByPlaylistidBySegmentidBySegmentcontainer(playlistId, segmentId, segmentContainer, id, container, deviceProfileId, deviceId, audioCodec, enableAutoStreamCopy, audioSampleRate, audioBitRate, audioChannels, maxAudioChannels, _static, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, maxWidth, maxHeight, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, videoCodec, audioStreamIndex, videoStreamIndex, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requires authentication as user
     * @param {string} id Item Id
     ...
     * @memberof VideoHlsServiceApi
     */
    public getVideosByIdLiveM3u8(id: string, container: string, deviceProfileId?: string, deviceId?: string, audioCodec?: string, enableAutoStreamCopy?: boolean, audioSampleRate?: number, audioBitRate?: number, audioChannels?: number, maxAudioChannels?: number, _static?: boolean, profile?: string, level?: string, framerate?: number, maxFramerate?: number, copyTimestamps?: boolean, startTimeTicks?: number, width?: number, height?: number, maxWidth?: number, maxHeight?: number, videoBitRate?: number, subtitleStreamIndex?: number, subtitleMethod?: string, maxRefFrames?: number, maxVideoBitDepth?: number, videoCodec?: string, audioStreamIndex?: number, videoStreamIndex?: number, options?: any) {
        return VideoHlsServiceApiFp(this.configuration).getVideosByIdLiveM3u8(id, container, deviceProfileId, deviceId, audioCodec, enableAutoStreamCopy, audioSampleRate, audioBitRate, audioChannels, maxAudioChannels, _static, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, maxWidth, maxHeight, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, videoCodec, audioStreamIndex, videoStreamIndex, options).then((request) => request(this.axios, this.basePath));
    }
}
