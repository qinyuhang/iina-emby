...
export const SystemServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getSystemLogs: async (options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getSystemLogsLog: async (name: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            if (name === null || name === undefined) {
                throw new RequiredError('name','Required parameter name was null or undefined when calling getSystemLogsLog.');
            }
...
export const SystemServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getSystemLogs(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<LogFile>>> {
            const localVarAxiosArgs = await SystemServiceApiAxiosParamCreator(configuration).getSystemLogs(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getSystemLogsLog(name: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await SystemServiceApiAxiosParamCreator(configuration).getSystemLogsLog(name, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const SystemServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getSystemLogs(options?: any): AxiosPromise<Array<LogFile>> {
            return SystemServiceApiFp(configuration).getSystemLogs(options).then((request) => request(axios, basePath));
        },
        /**
         * Requires authentication as administrator
         * @summary Gets a log file
         ...
         * @throws {RequiredError}
         */
        getSystemLogsLog(name: string, options?: any): AxiosPromise<void> {
            return SystemServiceApiFp(configuration).getSystemLogsLog(name, options).then((request) => request(axios, basePath));
        },
        /**
         * No authentication required
         * @param {*} [options] Override http request option.
...
export class SystemServiceApi extends BaseAPI {
     ...
     * @memberof SystemServiceApi
     */
    public getSystemLogs(options?: any) {
        return SystemServiceApiFp(this.configuration).getSystemLogs(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requires authentication as administrator
     * @summary Gets a log file
     ...
     * @memberof SystemServiceApi
     */
    public getSystemLogsLog(name: string, options?: any) {
        return SystemServiceApiFp(this.configuration).getSystemLogsLog(name, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * No authentication required
     * @param {*} [options] Override http request option.
