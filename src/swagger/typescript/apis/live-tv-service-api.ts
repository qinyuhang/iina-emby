...
import { LiveTvGetPrograms } from '../models';
import { LiveTvGuideInfo } from '../models';
import { LiveTvListingProviderTypeInfo } from '../models';
...
import { LiveTvSetChannelMapping } from '../models';
...
export const LiveTvServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getLivetvListingproviders: async (options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/LiveTv/ListingProviders`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getLivetvRecordingsGroups: async (userId?: string, options: any = {}): Promise<RequestArgs> => {
         ...
         * @param {string} id Recording group Id
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getLivetvRecordingsGroupsById: async (id: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling getLivetvRecordingsGroupsById.');
            }
            const localVarPath = `/LiveTv/Recordings/Groups/{Id}`
                .replace(`{${"Id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getLivetvRecordingsSeries: async (channelId?: string, userId?: string, groupId?: string, startIndex?: number, limit?: number, status?: string, isInProgress?: boolean, seriesTimerId?: string, enableImages?: boolean, imageTypeLimit?: number, enableImageTypes?: string, fields?: string, enableUserData?: boolean, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getLivetvSeriestimers: async (sortBy?: string, sortOrder?: string, options: any = {}): Promise<RequestArgs> => {
        ...
        /**
         * Requires authentication as user
         * @param {LiveTvSetChannelMapping} body SetChannelMapping
         * @param {string} providerId Provider id
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        postLivetvChannelmappings: async (body: LiveTvSetChannelMapping, providerId: string, options: any = {}): Promise<RequestArgs> => {
         ...
         * Requires authentication as user
         * @summary Gets available live tv epgs..
         * @param {LiveTvGetPrograms} body GetPrograms
         * @param {string} [channelIds] The channels to return guide information for.
         * @param {string} [userId] Optional filter by user id.
         * @param {string} [minStartDate] Optional. The minimum premiere date. Format &#x3D; ISO
         * @param {string} [maxStartDate] Optional. The maximum premiere date. Format &#x3D; ISO
         ...
         * @throws {RequiredError}
         */
        postLivetvPrograms: async (body: LiveTvGetPrograms, channelIds?: string, userId?: string, minStartDate?: string, maxStartDate?: string, minEndDate?: string, maxEndDate?: string, isMovie?: boolean, isSeries?: boolean, isNews?: boolean, isKids?: boolean, isSports?: boolean, genreIds?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
         ...
         * @throws {RequiredError}
         */
        putLivetvChannelmappings: async (body: LiveTvSetChannelMapping, providerId: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
...
export const LiveTvServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getLivetvListingproviders(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<LiveTvListingsProviderInfo>>> {
            const localVarAxiosArgs = await LiveTvServiceApiAxiosParamCreator(configuration).getLivetvListingproviders(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getLivetvListingprovidersAvailable(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<LiveTvListingProviderTypeInfo>>> {
         ...
         * @throws {RequiredError}
         */
        async getLivetvRecordingsGroups(userId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QueryResultBaseItemDto>> {
            const localVarAxiosArgs = await LiveTvServiceApiAxiosParamCreator(configuration).getLivetvRecordingsGroups(userId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getLivetvRecordingsGroupsById(id: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BaseItemDto>> {
            const localVarAxiosArgs = await LiveTvServiceApiAxiosParamCreator(configuration).getLivetvRecordingsGroupsById(id, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getLivetvRecordingsSeries(channelId?: string, userId?: string, groupId?: string, startIndex?: number, limit?: number, status?: string, isInProgress?: boolean, seriesTimerId?: string, enableImages?: boolean, imageTypeLimit?: number, enableImageTypes?: string, fields?: string, enableUserData?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QueryResultBaseItemDto>> {
            const localVarAxiosArgs = await LiveTvServiceApiAxiosParamCreator(configuration).getLivetvRecordingsSeries(channelId, userId, groupId, startIndex, limit, status, isInProgress, seriesTimerId, enableImages, imageTypeLimit, enableImageTypes, fields, enableUserData, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getLivetvSeriestimers(sortBy?: string, sortOrder?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QueryResultLiveTvSeriesTimerInfoDto>> {
            const localVarAxiosArgs = await LiveTvServiceApiAxiosParamCreator(configuration).getLivetvSeriestimers(sortBy, sortOrder, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async postLivetvChannelmappings(body: LiveTvSetChannelMapping, providerId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async putLivetvChannelmappings(body: LiveTvSetChannelMapping, providerId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export const LiveTvServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getLivetvListingproviders(options?: any): AxiosPromise<Array<LiveTvListingsProviderInfo>> {
            return LiveTvServiceApiFp(configuration).getLivetvListingproviders(options).then((request) => request(axios, basePath));
        },
        /**
         * Requires authentication as user
         * @summary Gets listing provider
         ...
         * @throws {RequiredError}
         */
        getLivetvListingprovidersAvailable(options?: any): AxiosPromise<Array<LiveTvListingProviderTypeInfo>> {
         ...
         * @throws {RequiredError}
         */
        getLivetvRecordingsGroups(userId?: string, options?: any): AxiosPromise<QueryResultBaseItemDto> {
            return LiveTvServiceApiFp(configuration).getLivetvRecordingsGroups(userId, options).then((request) => request(axios, basePath));
        },
        /**
         * Requires authentication as user
         * @summary Gets a recording group
         ...
         * @throws {RequiredError}
         */
        getLivetvRecordingsGroupsById(id: string, options?: any): AxiosPromise<BaseItemDto> {
            return LiveTvServiceApiFp(configuration).getLivetvRecordingsGroupsById(id, options).then((request) => request(axios, basePath));
        },
        /**
         * Requires authentication as user
         * @summary Gets live tv recordings
         ...
         * @throws {RequiredError}
         */
        getLivetvRecordingsSeries(channelId?: string, userId?: string, groupId?: string, startIndex?: number, limit?: number, status?: string, isInProgress?: boolean, seriesTimerId?: string, enableImages?: boolean, imageTypeLimit?: number, enableImageTypes?: string, fields?: string, enableUserData?: boolean, options?: any): AxiosPromise<QueryResultBaseItemDto> {
            return LiveTvServiceApiFp(configuration).getLivetvRecordingsSeries(channelId, userId, groupId, startIndex, limit, status, isInProgress, seriesTimerId, enableImages, imageTypeLimit, enableImageTypes, fields, enableUserData, options).then((request) => request(axios, basePath));
        },
        /**
         * Requires authentication as user
         * @summary Gets live tv series timers
         ...
         * @throws {RequiredError}
         */
        getLivetvSeriestimers(sortBy?: string, sortOrder?: string, options?: any): AxiosPromise<QueryResultLiveTvSeriesTimerInfoDto> {
            return LiveTvServiceApiFp(configuration).getLivetvSeriestimers(sortBy, sortOrder, options).then((request) => request(axios, basePath));
        },
        /**
         * Requires authentication as user
         * @summary Gets a live tv series timer
         ...
         * @throws {RequiredError}
         */
        postLivetvChannelmappings(body: LiveTvSetChannelMapping, providerId: string, options?: any): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        postLivetvPrograms(body: LiveTvGetPrograms, channelIds?: string, userId?: string, minStartDate?: string, maxStartDate?: string, minEndDate?: string, maxEndDate?: string, isMovie?: boolean, isSeries?: boolean, isNews?: boolean, isKids?: boolean, isSports?: boolean, genreIds?: string, options?: any): AxiosPromise<QueryResultBaseItemDto> {
         ...
         * @throws {RequiredError}
         */
        putLivetvChannelmappings(body: LiveTvSetChannelMapping, providerId: string, options?: any): AxiosPromise<void> {
...
export class LiveTvServiceApi extends BaseAPI {
     ...
     * @memberof LiveTvServiceApi
     */
    public getLivetvListingproviders(options?: any) {
        return LiveTvServiceApiFp(this.configuration).getLivetvListingproviders(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requires authentication as user
     * @summary Gets listing provider
     ...
     * @memberof LiveTvServiceApi
     */
    public getLivetvRecordingsGroups(userId?: string, options?: any) {
        return LiveTvServiceApiFp(this.configuration).getLivetvRecordingsGroups(userId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requires authentication as user
     * @summary Gets a recording group
     ...
     * @memberof LiveTvServiceApi
     */
    public getLivetvRecordingsGroupsById(id: string, options?: any) {
        return LiveTvServiceApiFp(this.configuration).getLivetvRecordingsGroupsById(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requires authentication as user
     * @summary Gets live tv recordings
     ...
     * @memberof LiveTvServiceApi
     */
    public getLivetvRecordingsSeries(channelId?: string, userId?: string, groupId?: string, startIndex?: number, limit?: number, status?: string, isInProgress?: boolean, seriesTimerId?: string, enableImages?: boolean, imageTypeLimit?: number, enableImageTypes?: string, fields?: string, enableUserData?: boolean, options?: any) {
        return LiveTvServiceApiFp(this.configuration).getLivetvRecordingsSeries(channelId, userId, groupId, startIndex, limit, status, isInProgress, seriesTimerId, enableImages, imageTypeLimit, enableImageTypes, fields, enableUserData, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requires authentication as user
     * @summary Gets live tv series timers
     ...
     * @memberof LiveTvServiceApi
     */
    public getLivetvSeriestimers(sortBy?: string, sortOrder?: string, options?: any) {
        return LiveTvServiceApiFp(this.configuration).getLivetvSeriestimers(sortBy, sortOrder, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requires authentication as user
     * @summary Gets a live tv series timer
     ...
     * @memberof LiveTvServiceApi
     */
    public postLivetvChannelmappings(body: LiveTvSetChannelMapping, providerId: string, options?: any) {
     ...
     * @memberof LiveTvServiceApi
     */
    public postLivetvPrograms(body: LiveTvGetPrograms, channelIds?: string, userId?: string, minStartDate?: string, maxStartDate?: string, minEndDate?: string, maxEndDate?: string, isMovie?: boolean, isSeries?: boolean, isNews?: boolean, isKids?: boolean, isSports?: boolean, genreIds?: string, options?: any) {
     ...
     * @memberof LiveTvServiceApi
     */
    public putLivetvChannelmappings(body: LiveTvSetChannelMapping, providerId: string, options?: any) {
