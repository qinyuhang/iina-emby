 ...
 * @export
 */
export const MusicGenresServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @throws {RequiredError}
         */
        getMusicgenresByName: async (name: string, userId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            if (name === null || name === undefined) {
                throw new RequiredError('name','Required parameter name was null or undefined when calling getMusicgenresByName.');
            }
            const localVarPath = `/MusicGenres/{Name}`
 ...
 * @export
 */
export const MusicGenresServiceApiFp = function(configuration?: Configuration) {
    return {
        /**
         * Requires authentication as user
         * @summary Gets all music genres from a given item, folder, or the entire library
         ...
         * @throws {RequiredError}
         */
        async getMusicgenresByName(name: string, userId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BaseItemDto>> {
            const localVarAxiosArgs = await MusicGenresServiceApiAxiosParamCreator(configuration).getMusicgenresByName(name, userId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
 ...
 * @export
 */
export const MusicGenresServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * Requires authentication as user
         * @summary Gets all music genres from a given item, folder, or the entire library
         ...
         * @throws {RequiredError}
         */
        getMusicgenresByName(name: string, userId?: string, options?: any): AxiosPromise<BaseItemDto> {
            return MusicGenresServiceApiFp(configuration).getMusicgenresByName(name, userId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class MusicGenresServiceApi extends BaseAPI {
    ...
    public getMusicgenresByName(name: string, userId?: string, options?: any) {
        return MusicGenresServiceApiFp(this.configuration).getMusicgenresByName(name, userId, options).then((request) => request(this.axios, this.basePath));
    }
}
