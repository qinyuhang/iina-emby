...
export const LibraryStructureServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getLibraryVirtualfolders: async (options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/Library/VirtualFolders`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
...
export const LibraryStructureServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getLibraryVirtualfolders(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<VirtualFolderInfo>>> {
            const localVarAxiosArgs = await LibraryStructureServiceApiAxiosParamCreator(configuration).getLibraryVirtualfolders(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const LibraryStructureServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getLibraryVirtualfolders(options?: any): AxiosPromise<Array<VirtualFolderInfo>> {
            return LibraryStructureServiceApiFp(configuration).getLibraryVirtualfolders(options).then((request) => request(axios, basePath));
        },
        /**
         * Requires authentication as administrator
         * @param {LibraryAddVirtualFolder} body AddVirtualFolder
...
export class LibraryStructureServiceApi extends BaseAPI {
     ...
     * @memberof LibraryStructureServiceApi
     */
    public getLibraryVirtualfolders(options?: any) {
        return LibraryStructureServiceApiFp(this.configuration).getLibraryVirtualfolders(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requires authentication as administrator
     * @param {LibraryAddVirtualFolder} body AddVirtualFolder
