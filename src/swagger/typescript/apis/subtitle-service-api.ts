...
export const SubtitleServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async postItemsByIdRemotesearchSubtitlesBySubtitleid(id: string, subtitleId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SubtitlesSubtitleDownloadResult>> {
...
export const SubtitleServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        postItemsByIdRemotesearchSubtitlesBySubtitleid(id: string, subtitleId: string, options?: any): AxiosPromise<SubtitlesSubtitleDownloadResult> {
