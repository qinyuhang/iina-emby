 ...
 * @export
 */
export const GameGenresServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @throws {RequiredError}
         */
        getGamegenresByName: async (name: string, userId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            if (name === null || name === undefined) {
                throw new RequiredError('name','Required parameter name was null or undefined when calling getGamegenresByName.');
            }
            const localVarPath = `/GameGenres/{Name}`
...
export const GameGenresServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getGamegenresByName(name: string, userId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BaseItemDto>> {
            const localVarAxiosArgs = await GameGenresServiceApiAxiosParamCreator(configuration).getGamegenresByName(name, userId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
 ...
 * @export
 */
export const GameGenresServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * Requires authentication as user
         * @summary Gets all Game genres from a given item, folder, or the entire library
         ...
         * @throws {RequiredError}
         */
        getGamegenresByName(name: string, userId?: string, options?: any): AxiosPromise<BaseItemDto> {
            return GameGenresServiceApiFp(configuration).getGamegenresByName(name, userId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class GameGenresServiceApi extends BaseAPI {
    ...
    public getGamegenresByName(name: string, userId?: string, options?: any) {
        return GameGenresServiceApiFp(this.configuration).getGamegenresByName(name, userId, options).then((request) => request(this.axios, this.basePath));
    }
}
