...
export const PlaystateServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        postUsersByUseridPlayingitemsByIdProgress: async (userId: string, id: string, mediaSourceId: string, positionTicks?: number, isPaused?: boolean, isMuted?: boolean, audioStreamIndex?: number, subtitleStreamIndex?: number, volumeLevel?: number, playMethod?: string, liveStreamId?: string, playSessionId?: string, repeatMode?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'userId' is not null or undefined
            if (userId === null || userId === undefined) {
...
export const PlaystateServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async postUsersByUseridPlayingitemsByIdProgress(userId: string, id: string, mediaSourceId: string, positionTicks?: number, isPaused?: boolean, isMuted?: boolean, audioStreamIndex?: number, subtitleStreamIndex?: number, volumeLevel?: number, playMethod?: string, liveStreamId?: string, playSessionId?: string, repeatMode?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await PlaystateServiceApiAxiosParamCreator(configuration).postUsersByUseridPlayingitemsByIdProgress(userId, id, mediaSourceId, positionTicks, isPaused, isMuted, audioStreamIndex, subtitleStreamIndex, volumeLevel, playMethod, liveStreamId, playSessionId, repeatMode, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const PlaystateServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        postUsersByUseridPlayingitemsByIdProgress(userId: string, id: string, mediaSourceId: string, positionTicks?: number, isPaused?: boolean, isMuted?: boolean, audioStreamIndex?: number, subtitleStreamIndex?: number, volumeLevel?: number, playMethod?: string, liveStreamId?: string, playSessionId?: string, repeatMode?: string, options?: any): AxiosPromise<void> {
            return PlaystateServiceApiFp(configuration).postUsersByUseridPlayingitemsByIdProgress(userId, id, mediaSourceId, positionTicks, isPaused, isMuted, audioStreamIndex, subtitleStreamIndex, volumeLevel, playMethod, liveStreamId, playSessionId, repeatMode, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class PlaystateServiceApi extends BaseAPI {
     ...
     * @memberof PlaystateServiceApi
     */
    public postUsersByUseridPlayingitemsByIdProgress(userId: string, id: string, mediaSourceId: string, positionTicks?: number, isPaused?: boolean, isMuted?: boolean, audioStreamIndex?: number, subtitleStreamIndex?: number, volumeLevel?: number, playMethod?: string, liveStreamId?: string, playSessionId?: string, repeatMode?: string, options?: any) {
        return PlaystateServiceApiFp(this.configuration).postUsersByUseridPlayingitemsByIdProgress(userId, id, mediaSourceId, positionTicks, isPaused, isMuted, audioStreamIndex, subtitleStreamIndex, volumeLevel, playMethod, liveStreamId, playSessionId, repeatMode, options).then((request) => request(this.axios, this.basePath));
    }
}
