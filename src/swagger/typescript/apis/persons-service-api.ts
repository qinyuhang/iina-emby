 ...
 * @export
 */
export const PersonsServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @throws {RequiredError}
         */
        getPersonsByName: async (name: string, userId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            if (name === null || name === undefined) {
                throw new RequiredError('name','Required parameter name was null or undefined when calling getPersonsByName.');
            }
...
export const PersonsServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getPersonsByName(name: string, userId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BaseItemDto>> {
            const localVarAxiosArgs = await PersonsServiceApiAxiosParamCreator(configuration).getPersonsByName(name, userId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
 ...
 * @export
 */
export const PersonsServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * Requires authentication as user
         * @summary Gets all persons from a given item, folder, or the entire library
         ...
         * @throws {RequiredError}
         */
        getPersonsByName(name: string, userId?: string, options?: any): AxiosPromise<BaseItemDto> {
            return PersonsServiceApiFp(configuration).getPersonsByName(name, userId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class PersonsServiceApi extends BaseAPI {
    ...
    public getPersonsByName(name: string, userId?: string, options?: any) {
        return PersonsServiceApiFp(this.configuration).getPersonsByName(name, userId, options).then((request) => request(this.axios, this.basePath));
    }
}
