...
export const ItemLookupServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        postItemsRemotesearchBoxset: async (body: ProvidersRemoteSearchQueryProvidersItemLookupInfo, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
...
export const ItemLookupServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async postItemsRemotesearchBoxset(body: ProvidersRemoteSearchQueryProvidersItemLookupInfo, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RemoteSearchResult>>> {
...
export const ItemLookupServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        postItemsRemotesearchBoxset(body: ProvidersRemoteSearchQueryProvidersItemLookupInfo, options?: any): AxiosPromise<Array<RemoteSearchResult>> {
...
export class ItemLookupServiceApi extends BaseAPI {
     ...
     * @memberof ItemLookupServiceApi
     */
    public postItemsRemotesearchBoxset(body: ProvidersRemoteSearchQueryProvidersItemLookupInfo, options?: any) {
