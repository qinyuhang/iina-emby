 ...
 * @export
 */
export const GenresServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @throws {RequiredError}
         */
        getGenresByName: async (name: string, userId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            if (name === null || name === undefined) {
                throw new RequiredError('name','Required parameter name was null or undefined when calling getGenresByName.');
            }
            const localVarPath = `/Genres/{Name}`
...
export const GenresServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getGenresByName(name: string, userId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BaseItemDto>> {
            const localVarAxiosArgs = await GenresServiceApiAxiosParamCreator(configuration).getGenresByName(name, userId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
 ...
 * @export
 */
export const GenresServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * Requires authentication as user
         * @summary Gets all genres from a given item, folder, or the entire library
         ...
         * @throws {RequiredError}
         */
        getGenresByName(name: string, userId?: string, options?: any): AxiosPromise<BaseItemDto> {
            return GenresServiceApiFp(configuration).getGenresByName(name, userId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class GenresServiceApi extends BaseAPI {
    ...
    public getGenresByName(name: string, userId?: string, options?: any) {
        return GenresServiceApiFp(this.configuration).getGenresByName(name, userId, options).then((request) => request(this.axios, this.basePath));
    }
}
