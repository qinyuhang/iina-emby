 ...
 * @export
 */
export const StudiosServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @throws {RequiredError}
         */
        getStudiosByName: async (name: string, userId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            if (name === null || name === undefined) {
                throw new RequiredError('name','Required parameter name was null or undefined when calling getStudiosByName.');
            }
...
export const StudiosServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getStudiosByName(name: string, userId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BaseItemDto>> {
            const localVarAxiosArgs = await StudiosServiceApiAxiosParamCreator(configuration).getStudiosByName(name, userId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
 ...
 * @export
 */
export const StudiosServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * Requires authentication as user
         * @summary Gets all studios from a given item, folder, or the entire library
         ...
         * @throws {RequiredError}
         */
        getStudiosByName(name: string, userId?: string, options?: any): AxiosPromise<BaseItemDto> {
            return StudiosServiceApiFp(configuration).getStudiosByName(name, userId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class StudiosServiceApi extends BaseAPI {
    ...
    public getStudiosByName(name: string, userId?: string, options?: any) {
        return StudiosServiceApiFp(this.configuration).getStudiosByName(name, userId, options).then((request) => request(this.axios, this.basePath));
    }
}
