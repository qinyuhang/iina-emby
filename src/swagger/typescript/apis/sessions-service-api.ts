...
export const SessionsServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAuthKeys: async (startIndex?: number, limit?: number, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getSessions: async (controllableByUserId?: string, deviceId?: string, id?: string, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getSessionsPlayqueue: async (id?: string, deviceId?: string, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        postSessionsCapabilities: async (id: string, playableMediaTypes?: string, supportedCommands?: string, supportsMediaControl?: boolean, supportsSync?: boolean, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
...
export const SessionsServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getAuthKeys(startIndex?: number, limit?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await SessionsServiceApiAxiosParamCreator(configuration).getAuthKeys(startIndex, limit, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getSessions(controllableByUserId?: string, deviceId?: string, id?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<SessionSessionInfo>>> {
            const localVarAxiosArgs = await SessionsServiceApiAxiosParamCreator(configuration).getSessions(controllableByUserId, deviceId, id, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getSessionsPlayqueue(id?: string, deviceId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QueryResultBaseItemDto>> {
            const localVarAxiosArgs = await SessionsServiceApiAxiosParamCreator(configuration).getSessionsPlayqueue(id, deviceId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async postSessionsCapabilities(id: string, playableMediaTypes?: string, supportedCommands?: string, supportsMediaControl?: boolean, supportsSync?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await SessionsServiceApiAxiosParamCreator(configuration).postSessionsCapabilities(id, playableMediaTypes, supportedCommands, supportsMediaControl, supportsSync, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const SessionsServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAuthKeys(startIndex?: number, limit?: number, options?: any): AxiosPromise<void> {
            return SessionsServiceApiFp(configuration).getAuthKeys(startIndex, limit, options).then((request) => request(axios, basePath));
        },
        /**
         * Requires authentication as administrator
         * @param {*} [options] Override http request option.
         ...
         * @throws {RequiredError}
         */
        getSessions(controllableByUserId?: string, deviceId?: string, id?: string, options?: any): AxiosPromise<Array<SessionSessionInfo>> {
            return SessionsServiceApiFp(configuration).getSessions(controllableByUserId, deviceId, id, options).then((request) => request(axios, basePath));
        },
        /**
         * Requires authentication as user
         * @summary Gets a the current play queue from a session
         ...
         * @throws {RequiredError}
         */
        getSessionsPlayqueue(id?: string, deviceId?: string, options?: any): AxiosPromise<QueryResultBaseItemDto> {
            return SessionsServiceApiFp(configuration).getSessionsPlayqueue(id, deviceId, options).then((request) => request(axios, basePath));
        },
        /**
         * Requires authentication as administrator
         * @param {string} app App
         ...
         * @throws {RequiredError}
         */
        postSessionsCapabilities(id: string, playableMediaTypes?: string, supportedCommands?: string, supportsMediaControl?: boolean, supportsSync?: boolean, options?: any): AxiosPromise<void> {
            return SessionsServiceApiFp(configuration).postSessionsCapabilities(id, playableMediaTypes, supportedCommands, supportsMediaControl, supportsSync, options).then((request) => request(axios, basePath));
        },
        /**
         * Requires authentication as user
         * @summary Updates capabilities for a device
...
export class SessionsServiceApi extends BaseAPI {
    ...
    public getAuthKeys(startIndex?: number, limit?: number, options?: any) {
        return SessionsServiceApiFp(this.configuration).getAuthKeys(startIndex, limit, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requires authentication as administrator
     * @param {*} [options] Override http request option.
     ...
     * @memberof SessionsServiceApi
     */
    public getSessions(controllableByUserId?: string, deviceId?: string, id?: string, options?: any) {
        return SessionsServiceApiFp(this.configuration).getSessions(controllableByUserId, deviceId, id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requires authentication as user
     * @summary Gets a the current play queue from a session
    ...
    public getSessionsPlayqueue(id?: string, deviceId?: string, options?: any) {
        return SessionsServiceApiFp(this.configuration).getSessionsPlayqueue(id, deviceId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requires authentication as administrator
     * @param {string} app App
     ...
     * @memberof SessionsServiceApi
     */
    public postSessionsCapabilities(id: string, playableMediaTypes?: string, supportedCommands?: string, supportsMediaControl?: boolean, supportsSync?: boolean, options?: any) {
        return SessionsServiceApiFp(this.configuration).postSessionsCapabilities(id, playableMediaTypes, supportedCommands, supportsMediaControl, supportsSync, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requires authentication as user
     * @summary Updates capabilities for a device
